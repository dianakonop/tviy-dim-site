...
function BuildingPassportRegionPrices() {
    ...
    <section className="commissioning-flow">
      <div className="container">
        <div className="commissioning-flow__card commissioning-flow__card--prices">
          ...
          <div className="commissioning-flow__watermark commissioning-flow__watermark--building-region">
            ОБЛАСТЬ
          </div>
          ...
          <div className="commissioning-flow__prices">
            <div className="commissioning-flow__price-card">
              ...
              <div className="commissioning-flow__price-value">8000 грн</div>
            </div>
...
export default BuildingPassportRegionPrices